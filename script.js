...
function applyLanguageToDOM(lang) {
  ...
  if (heroTitleMain) {
    heroTitleMain.innerHTML = isBn ? '<span class="wub-word-badge">WUB</span> ব্লাড<span class="text-accent-red">কেয়ার</span>' : '<span class="wub-word-badge">WUB</span> Blood<span class="text-accent-red">Care</span>';
  }
